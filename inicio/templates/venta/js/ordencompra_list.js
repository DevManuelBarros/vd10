<script type="text/javascript">
	...
	function filtroOrdenCompra() 
	{
		  ...
		  input = document.getElementById("filtroOrdenCompra");
		  ...
		  input3 = document.getElementById("filtroCircuito");
		 ...
		 for (i = 0; i < tr.length; i++) 
		 {
		    ...
		    if (td && td2 && td3) 
		    {
		      ...
		      if(txtValue3.toUpperCase().indexOf('CONSIGNACION') > -1)
		      {

		        txtValue3 = 'CONSIGNACION';
		      }
		      else
		      {
		      	txtValue3 = 'FACTURAR';
